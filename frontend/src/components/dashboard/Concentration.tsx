      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
        <Card className="border-border">
          <CardContent className="p-4 sm:p-6 lg:p-8 relative">
            ...
            <div className="flex justify-between items-start mb-6">
              <h3 className="font-bold text-lg text-foreground">Your Funds:</h3>
              <Badge
                variant={
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 sm:mb-8">
              <div className="p-4 sm:p-6 bg-destructive/10 rounded-2xl border border-destructive/30">
                <p className="text-muted-foreground text-[10px] font-bold uppercase mb-1">
                  Current funds
                </p>
                <h4 className="text-2xl sm:text-3xl font-bold text-destructive font-mono">
                  {con.fund_count}
                </h4>
              </div>
              <div className="p-4 sm:p-6 bg-muted rounded-2xl border border-border">
                <p className="text-muted-foreground text-[10px] font-bold uppercase mb-1">
                  Recommended funds
                </p>
                <h4 className="text-2xl sm:text-3xl font-bold text-foreground font-mono">7-10</h4>
              </div>
            </div>
        ...
        <Card className="border-border">
          <CardContent className="p-4 sm:p-6 lg:p-8 relative">
            ...
            <div className="flex justify-between items-start mb-6">
              <h3 className="font-bold text-lg text-foreground">Your AMCs:</h3>
              <Badge
                variant={
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 sm:mb-8">
              ...
              <div className="p-4 sm:p-6 bg-muted rounded-2xl border border-border">
                ...
                <h4 className="text-2xl sm:text-3xl font-bold text-foreground font-mono">5-7</h4>
              </div>
            </div>
            <div className="overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0">
            <Table>
