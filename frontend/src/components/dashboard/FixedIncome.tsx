        ...
        <div className="col-span-2 space-y-4 sm:space-y-6 lg:space-y-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <Card className="border-border">
              <CardContent className="p-4 sm:p-6">
                ...
                <h4 className="text-xl font-bold text-foreground font-mono">{fi.irr}%</h4>
              </CardContent>
            </Card>
            <Card className="border-border">
              <CardContent className="p-4 sm:p-6">
                ...
                <h4 className="text-xl font-bold text-foreground font-mono">{fi.ytm}%</h4>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="border-border">
            <CardContent className="p-4 sm:p-6 lg:p-8 relative">
              ...
              <h3 className="font-bold text-base sm:text-lg text-foreground mb-6 sm:mb-8">
                Credit Quality
              </h3>
                ...
                <div className="space-y-6 w-full sm:w-1/3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{ backgroundColor: CHART_COLORS_3[0] }}
                      />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className="size-3 rounded-full"
                        style={{ backgroundColor: CHART_COLORS_3[1] }}
                      />
                      <span className="text-sm text-muted-foreground font-bold uppercase tracking-wider">
                        AA
                      </span>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className="size-3 rounded-full"
                        style={{ backgroundColor: CHART_COLORS_3[2] }}
                      />
                      <span className="text-sm text-muted-foreground font-bold uppercase tracking-wider">
                        Below AA
                      </span>
          ...
          <Card className="border-border">
            <CardContent className="p-4 sm:p-6 lg:p-8 relative">
              ...
              <h3 className="font-bold text-lg text-foreground mb-6 sm:mb-8">
                ...
                {fi.category_allocation.map((a, i) => (
                  <div key={i}>
                    <div className="flex justify-between text-xs font-bold mb-2">
                      ...
                      <span className="text-foreground font-mono">{a.allocation_pct}%</span>
                    </div>
                    ...
                    <TableBody>
                      {fi.top_funds.map((f, i) => (
                        <TableRow key={i}>
                          ...
                          <TableCell className="text-right font-bold text-foreground font-mono py-3">
                            {f.allocation_pct}%
                          </TableCell>
                        </TableRow>
                      ))}
