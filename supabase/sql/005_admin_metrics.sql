...
revoke execute on function public.admin_overview_metrics() from anon, authenticated;
revoke execute on function public.admin_user_rollup(integer) from anon, authenticated;
revoke execute on function public.admin_recent_runs(integer) from anon, authenticated;
revoke execute on function public.admin_recent_user_events(integer) from anon, authenticated;
